  ...
  return (
    ...
    >
          ...
          >
            ...
            <Box
              sx={{
                ...
                border: msg.role === "ai" && !msg.isError ? "1px solid #e8eaed" : "none",
              }}
            >
              <Typography
                variant="body2"
      ...
      >
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              height: 40,
              borderRadius: "50%",
              bgcolor: userMessage.trim() ? "#1a1a1a" : "#e0e3e8",
              color: userMessage.trim() ? "#61dafb" : "#aaa",
              flexShrink: 0,
              mb: 0.25,
              "&:hover": {
                bgcolor: userMessage.trim() ? "#333" : "#e0e3e8",
              },
        ...
        <Typography variant="caption" sx={{ color: "#aaa", pl: 2, mt: 0.5, display: "block" }}>
          Press Enter to send
        </Typography>
      </Box>
    </Box>
